...
public class N2V implements Command {
	...
	private File graphDefFile = new File("/home/random/Development/imagej/project/CSBDeep/N2V/model/tf_model.pb");
...
//		final File file = new File("/home/random/Development/imagej/project/CSBDeep/data/N2V/pred_train.tif");
		final File file = new File("/home/random/Development/python/n2v_test/data/train.tif");
